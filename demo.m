...
data = load('D:\chm\data\dataset\MSRA25.mat','X');
label = load('D:\chm\data\dataset\MSRA25.mat','Y');
...
workbook = excel.Workbooks.Open('D:\chm\data\RFKM\result.xlsx');
worksheet = workbook.Sheets.Item(6);
for r = 1.1 : 0.1 : 2 
for percent = 0.05 : 0.05 : 0.4
for K = 5 : 5 : 100
...
while 0<1
    ...
    [F, obj_RFKM, iter, center, S] = RFKM(F, r, S, data, noise, center, K);
    % close all;
    [~,max_F] = max(F,[],2);
