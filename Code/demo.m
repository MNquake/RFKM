...
data = load('E:\Data\dataset\umist.mat','X');
label = load('E:\Data\dataset\umist.mat','Y');
...
workbook = excel.Workbooks.Open('E:\RFKM\result\RFKM_result.xlsx');
worksheet = workbook.Sheets.Item(8);
for r = 1.1 : 0.1 : 2 
